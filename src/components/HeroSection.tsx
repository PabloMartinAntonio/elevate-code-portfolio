    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-tight mb-6 animate-fade-up delay-100">
          Creo{" "}
          <span className="text-gradient">soluciones técnicas</span>
          <br />
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-up delay-200">
          Transformo ideas en sistemas robustos, automatizaciones inteligentes
          e infraestructura que impulsa tu crecimiento.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up delay-300">
          <Button
            ...
            onClick={() =>
              window.open(
                `https://wa.me/${settings.whatsappNumber}?text=Hola! Me interesa tu servicio de desarrollo.`,
                "_blank"
              )
            }
          >
